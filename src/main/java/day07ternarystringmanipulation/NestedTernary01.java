...
public class NestedTernary01 {
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            i)Yil 100 e bolunurse 400 e de bolunmeldir. ===> 1600+   1800-
            ii)Yil 100 e bolunmezse 4 e bolunmelidir   ===> 1996+   2001-
         */

        int year = 1600;
        String leap = year % 100 == 0 ? (year % 400 == 0 ? "Leap year" : "Leap year degil") : (year % 4 == 0 ? "Leap year" : "Leap degil");
        System.out.println(leap);

        /*
            Asagidaki kurallara gore password un gecerli olup olmadigini kontrol eden kodu yazin
